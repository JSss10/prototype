...
struct Landmark: Codable, Identifiable, Sendable, Equatable {
    ...
    // Custom decoding to handle missing columns gracefully
    init(from decoder: Decoder) throws {
        ...
        // Optional fields that exist in original schema
        ...
        // New fields - use try? to gracefully handle missing columns
        ...
        // Skip openingHoursSpecification as it's a complex JSON object
    ...
    // Computed property to get all photo URLs as an array
    var photoUrls: [String] {
        [photo0Url, photo1Url, photo2Url].compactMap { $0 }.filter { !$0.isEmpty }
    }

    // Computed property to get photos with captions
    ...
    var formattedOpeningHours: String? {
        // Prefer special opening hours if available
        ...
        // Parse schema.org format like "Su,Mo,Tu,We,Th,Fr,Sa 08:00:00-16:50:00"
        ...
        if parts.count == 2 {
            ...
            // Clean up time format (remove seconds)
            timeRange = timeRange
                .replacingOccurrences(of: ":00-", with: "-")
                .replacingOccurrences(of: ":00$", with: "", options: .regularExpression)

            // Remove seconds from times like "08:00:00" -> "08:00"
    ...
    // Format date modified for display (English only)
    var formattedDateModified: String? {
        ...
        // Try with simpler format (2025-11-05T16:13)
